  ...
  <div id="container">
    ...
    <div class="box-card">
      ...
      <div class="box-msg">
        ...
        <p class="box-date">开放时间：{{card.date}}</p>
        <p class="box-phone">咨询电话：{{card.phone}}</p>
      </div>
    </div>
    <!-- 基本信息结束 -->
    ...
    <div class="box-btn" v-if="true">
      ...
      <button class="box-btn-oder">
        <a href="http://sport.utools.club/gyms/xhty/siteReserveList.do?cid=46">
...
export default {
  ...
  created() {
    ...
    this.img = [
      "http://223.4.72.248:10084/api-file/files-anon/download?fileID=6b3f73d47ae84424b2065866969138af",
      "http://223.4.72.248:10084/api-file/files-anon/download?fileID=d54f5537256e4a639ac1c19f7155dd08",
      "http://223.4.72.248:10084/api-file/files-anon/download?fileID=0ce88b9c35cc483b80708ce6d8cf923b"
    ];
    this.card = {
      title: "奥体中心",
      bigType: "室外场地",
