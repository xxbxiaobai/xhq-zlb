<template>
  <div id="home">
    ...
    <div class="bottom">
      ...
      <button @click="cancelevent">取消报名</button>
...
export default {
  ...
  methods: {
    cancelevent() {
      console.log(this.listdata.trainInfo)
      if (this.listdata.isCancel == 0) {
        this.$toast("不可以取消报名")
      } else {
        this.$router.push({ name: "cancelreason", params: { id: this.listdata.id } })
      }
    }
  },
  created() {
